      ...
      >
        ...
        <defs>
          ...
          <linearGradient id="primary-grad" x1="0" y1="0" x2="1" y2="1">
            ...
            <stop offset="100%" stopColor="#16855b" />
          </linearGradient>
          ...
          <linearGradient id="sky-sun" x1="0" y1="0" x2="1" y2="1">
            ...
            <stop offset="50%" stopColor="#fde6b3" />
            <stop offset="100%" stopColor="#f6a623" />
          </linearGradient>

          <radialGradient id="portal-bg" cx="50%" cy="50%" r="50%">
            <stop offset="0%" stopColor="#ffffff" />
            <stop offset="60%" stopColor="#f2f9f5" />
            <stop offset="100%" stopColor="#e3f3ec" />
          </radialGradient>

          {/* Shadows */}
          <filter id="drop-shadow-soft" x="-20%" y="-20%" width="140%" height="140%">
            <feDropShadow dx="0" dy="16" stdDeviation="20" floodColor="#0b6b57" floodOpacity="0.12" />
          </filter>

          <filter id="drop-shadow-glow" x="-30%" y="-30%" width="160%" height="160%">
            <feDropShadow dx="0" dy="8" stdDeviation="12" floodColor="#f6a623" floodOpacity="0.25" />
          </filter>
        </defs>
        ...
        >
          ...
          <circle cx="360" cy="330" r="268" stroke="#d5ece2" strokeWidth="2" strokeDasharray="6 6" />
        </motion.g>
        ...
        {/* Floating Hope Rays */}
        <g stroke="#f6a623" strokeWidth="3" strokeLinecap="round" opacity="0.4">
        ...
        >
          ...
          <circle cx="280" cy="300" r="10" fill="#f6a623" />
          <circle cx="440" cy="300" r="10" fill="#f6a623" />
          <circle cx="360" cy="215" r="14" fill="#ffffff" stroke="#f6a623" strokeWidth="4" />
          <path d="M 360 207 L 360 223 M 352 215 L 368 215" stroke="#f6a623" strokeWidth="3" strokeLinecap="round" />
        </motion.g>
        ...
        >
          ...
          <g transform="translate(130, 240)">
            ...
            <circle cx="32" cy="32" r="22" fill="#eef8f3" />
            <path d="M22 28 L32 22 L42 28 L32 34 Z M25 31 V38 C25 41, 39 41, 39 38 V31" stroke="#0b6b57" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
          </g>

          {/* Right Floating Badge: Healthcare */}
          <g transform="translate(520, 260)">
            <rect width="64" height="64" rx="20" fill="#ffffff" filter="url(#drop-shadow-soft)" />
            <circle cx="32" cy="32" r="22" fill="#fff5e6" />
            <path d="M32 23 C27 19, 21 23, 24 29 L32 37 L40 29 C43 23, 37 19, 32 23 Z" fill="#f6a623" />
          </g>
        </motion.g>

        {/* Floating Sparkles & Light Orbs */}
        <circle cx="190" cy="160" r="6" fill="#f6a623" opacity="0.7" />
        <circle cx="550" cy="170" r="8" fill="#16855b" opacity="0.6" />
        <circle cx="160" cy="420" r="7" fill="#123b5d" opacity="0.5" />
        <circle cx="570" cy="430" r="5" fill="#f6a623" opacity="0.8" />
      </svg>
    </div>
  );
}
